...
?>
					...
					<span class="setting-description">
						<?php _e('The “Alt.” option is there so that you can add your own icon set or modify an included one.  Just make a set, name it <kbd>menu-alt.png</kbd> and put it in <code>wp-content/plugins/tangofy/images</code>.  If there is no <kbd>menu-alt.png</kbd> file, the “Alt.” option shows empty spaces for icons.&nbsp;:-)', 'tangofy') ?>
					</span>
				</td>
			</tr>
		</table>
